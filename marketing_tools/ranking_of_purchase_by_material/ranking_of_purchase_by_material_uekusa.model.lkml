...
explore: ranking_of_purchase_by_material_uekusa {
  ...
  join: dim_exp_1 {
    from: dim_expression
    sql_on:
      ${ranking_of_purchase_by_material_uekusa.project} = ${dim_exp_1.project} AND
  ...
  join: dim_exp_2 {
    from: dim_expression
    sql_on:
      ${ranking_of_purchase_by_material_uekusa.project} = ${dim_exp_2.project} AND
      ${ranking_of_purchase_by_material_uekusa.site_id} = ${dim_exp_2.key} AND
  ...
  join: dim_exp_3 {
    from: dim_expression
    sql_on:
      ${ranking_of_purchase_by_material_uekusa.project} = ${dim_exp_3.project} AND
      ${ranking_of_purchase_by_material_uekusa.site_id} = ${dim_exp_3.key} AND
  ...
  join: dim_exp_4 {
    from: dim_expression
    sql_on:
      ${ranking_of_purchase_by_material_uekusa.project} = ${dim_exp_4.project} AND
      CAST(${ranking_of_purchase_by_material_uekusa.payment_method_id} AS VARCHAR) = ${dim_exp_4.key} AND
